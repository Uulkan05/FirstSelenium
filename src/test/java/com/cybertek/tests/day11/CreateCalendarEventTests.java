...
public class CreateCalendarEventTests {
    ...
    public void verifySaveAndCloseDropdown() {
        ...
        SeleniumUtil.clickWithWait(driver, By.cssSelector(saveAndCloseDropdownLocator), 4);
    ...
    public void verifyStartDateAndTime(){
        ...
        String expectedTime = LocalTime.now().format(DateTimeFormatter.ofPattern("hh:mm a"));
